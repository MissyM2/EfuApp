...
namespace EfuApp.Plugins.EfCoreSqlServer.Migrations
{
    ...
    [Migration("20231109124334_CleanedUpCourseWeekTable")]
    partial class CleanedUpCourseWeekTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfuApp.CoreBusiness.CourseWeek", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfuApp.CoreBusiness.CourseWeek", b =>
                {
                    ...
                    b.HasOne("EfuApp.CoreBusiness.Week", "Week")
                        .WithMany("CourseWeeks")
            ...
            modelBuilder.Entity("EfuApp.CoreBusiness.Week", b =>
                {
                    b.HasOne("EfuApp.CoreBusiness.Term", null)
                        .WithMany("Weeks")
                        .HasForeignKey("TermId");
                });
